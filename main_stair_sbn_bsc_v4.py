...
# --- SBN-BSC v4 params (support both --sbn-* and standard naming) ---
cfg.add_argument("--sbn-tau-text", "--tau-text", dest="sbn_tau_text", type=float, default=0.15,
                 help="Text similarity threshold for modal agreement [0.05, 0.30]")
cfg.add_argument("--sbn-tau-visual", "--tau-visual", dest="sbn_tau_visual", type=float, default=0.10,
                 help="Visual similarity threshold for modal agreement [0.05, 0.25]")
cfg.add_argument("--sbn-modal-discount", "--modal-discount", dest="sbn_modal_discount", type=float, default=0.50,
                 help="Modal discount factor rho [0.30, 0.80]")
cfg.add_argument("--sbn-prune-lambda", "--prune-lambda", dest="sbn_prune_lambda", type=float, default=0.50,
                 help="Adaptive pruning lambda multiplier [0.30, 0.90]")
cfg.add_argument("--sbn-min-edge-threshold", "--min-edge-threshold", dest="sbn_min_edge_threshold", type=float, default=0.05,
                 help="Minimum edge quality threshold tau_min [0.01, 0.10]")
cfg.add_argument("--sbn-ablation-config", type=str, default="A6_full_sbn_bsc_v4",
