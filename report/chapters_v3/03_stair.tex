...
\paragraph{1. Zero-rotation Diagonal Spectral Projector.}
...
\paragraph{2. Stepwise Contrastive Learning trên các tầng trung gian.}
...
\paragraph{3. Soft Spectral Swapping.}
...
\paragraph{4. Adaptive False Negative Attenuation.}
...
\paragraph{1. Hiện tượng xung đột gradient ký sinh.}
...
\paragraph{2. Suy giảm tính đồng nhất do attenuation không ngưỡng.}
...
\paragraph{3. Hiện tượng bão hòa loss sớm trên đồ thị siêu thưa.}
...
\paragraph{1. Cross-Negative Spectral Swapping (CNSS).}
...
\paragraph{2. Thresholded Smooth False Negative Attenuation.}
...
\paragraph{3. L2 Anchoring Regularization cho Projector.}
...
\paragraph{4. Điều chỉnh nhiệt độ và trọng số loss trên tập Sports.}
